...
for (k in 1:length(ca$eig)) { # For each axis
  ind <- 1 # initialize row index
  for (obs in 1:nrow(Yfreq0)) { # For each observation
    i <- Yfreq0$row[obs]
    j <- Yfreq0$col[obs]
...
mrows_nr/ca$li
mrows_nr/mrows # It is different from the reciprocal scaling means

# Groupwise variance
varrows_nr <- varfacwt(H1, fac = Yfreq0$row, wt = Yfreq0$Freq)
varrows_nr/varrows # It is different from the reciprocal scaling means
...
mcols_nr/ca$co
mcols_nr/mcols # It is different from the reciprocal scaling means

# Groupwise variance
varcols_nr <- varfacwt(H1, fac = Yfreq0$col, wt = Yfreq0$Freq)
varcols_nr/varcols # It is different from the reciprocal scaling means
