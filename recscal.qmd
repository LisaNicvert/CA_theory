...
|                       | Rows (sites)                        | Columns (species)        |
|-----------------------|-------------------------------------|--------------------------|
| Mean for axis $k$     | $L1_k(i) \times \frac{1}{\sqrt{n}}$ | $C_k(j) \times \frac{1}{\sqrt{n}}$ |
...
|                       | Rows (sites)                      | Columns (species)        |
|-----------------------|-----------------------------------|--------------------------|
| Mean for axis $k$     | $$mR_k(i) = m_k(i) \times \frac{\sqrt{2}}{\sqrt{\mu_k n}}$$ | $$mR_k(j) = m_k(j) \times \frac{\sqrt{2 \lambda_k}}{\sqrt{\mu_k n}}$$ |
| Variance for axis $k$ | None | $$sR^2_k(j) = s^2_k(j) \times \frac{2 \mu_k}{n}$$ |
| Covariance between axes $k$, $l$ |  | |
...
|                       | Rows (sites)                      | Columns (species)        |
|-----------------------|-----------------------------------|--------------------------|
| Mean for axis $k$     | $$mC_k(i) = m_k(i) \times \frac{\sqrt{2 \lambda_k}}{\sqrt{\mu_k n}}$$ | $$mC_k(j) = m_k(j) \times \frac{\sqrt{2}}{\sqrt{\mu_k n}}$$ |
| Variance for axis $k$ | $$sC^2_k(i) = s^2_k(i) \times \frac{2 \mu_k}{n}$$ | None |
| Covariance between axes $k$, $l$ |  | |
